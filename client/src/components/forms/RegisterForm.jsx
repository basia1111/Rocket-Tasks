...
function RegisterForm (){
    ...
    return(
        <>
            ...
            >
                <Input value={formData.name} type="text" name="name" onChange={handleChange} placeholder="Enter your name" icon={IoPerson}  />
                ...
                <PasswordInput value={formData.checkPassword} name="checkPassword" onChange={handleChange} placeholder="Confirm password" /> 
                ...
                <div className="text-gray-400 flex items-center justify-center mt-4">
                    <p>Already have an account? <Link to="/login" className="text-green">Login here</Link></p>
                </div>
            </form>
        </>
    )
